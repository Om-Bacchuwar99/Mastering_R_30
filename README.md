...
### 📝 Project Overview
This repository is a comprehensive, day-by-day documentation of my journey into the R programming language. I am building a foundation in data science by committing to daily practice, documentation, and code uploads.

### 🎯 Learning Goals
* Master R syntax and core data structures (Vectors, Matrices, Data Frames).
* Implement data manipulation using the **Tidyverse** ecosystem.
* Create professional-grade visualizations with **ggplot2**.
* Perform exploratory data analysis (EDA) and basic statistical modeling.
...
| **Day 15** | Importing Data: CSV Files  | ✅ | [Folder](./Day%2015) |
| **Day 16** | Data Manipulation: Dplyr Package Intro  | ✅ | [Folder](./Day%2016) |
...
| **Day 30** | **Final Project: Conclusion and Validation** | ✅ | [Folder](./Day%2030) |
